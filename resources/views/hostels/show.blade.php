        ...
        <div class="card-body">
            <div class="row">
                <div class="col-12 col-sm-6">
                    <h3 class="d-inline-block d-sm-none">Hôtel {{$hostel->name}} </h3>
                    <div class="col-12">
                ...
                <div class="col-12 col-sm-6">
                    <h3 class="my-3">Hôtel {{$hostel->name}}

                    @if($hostel->user_id == Auth::id())<small> @if($hostel->isVerified()) <span class="badge badge-success text-sm"><i class="fas fa-check"></i> Vérifié</span> @else <span class="badge badge-warning text-sm">En attente</span> @endif </small>@endif
                    </h3>
                        ...
                        <div class="col-md-4 col-12">
                            ...
                            <div class="card-body">
                                <h4 class="mt-3">{{$room->name}}
                                    ...
                                    @if($hostel->user_id == Auth::id())<small> @if($room->isAvailable()) <span class="badge badge-success">Activée</span> @else <span class="badge badge-danger">Désactivée</span> @endif </small>@endif
                                </h4>
                                ...
                                @else
                                    <a  href="{{route('hostels.rooms.booking',['hostel'=>$hostel->id,'room'=>$room->id])}}" class="btn btn-success btn-sm">Réserver</a>
                                @endif
